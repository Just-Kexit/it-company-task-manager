...
urlpatterns = [
    ...
    path("workers/update/<int:pk>/", WorkerPositionUpdateView.as_view(), name="worker-update"),
    ...
    path("task-types/update/<int:pk>/", TaskTypeUpdateView.as_view(), name="task-type-update"),
    path("task-types/delete/<int:pk>/", TaskTypeDeleteView.as_view(), name="task-type-delete"),
